...
<head>
    ...
    <link rel="icon" href="{{asset('public/admin/images/favicon.ico')}}" type="image/ico" />

    <title>SIM SURAT ORMAWA KMPHB</title>
...
background: #8FBC8F; /* Old browsers */
...
<body>
    ...
    <div class="content">
        <div class="title animated rubberBand">
            SIM SURAT ORMAWA KMPHB 
        </div>
        <p>Sistem Manajemen Surat KMPHB</p>
